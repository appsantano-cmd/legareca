    ...
    <form id="petForm" action="{{ route('screening.submitPets') }}" method="POST">
            ...
            @for ($i = 0; $i < $count; $i++)
                <div class="form-card p-5 border border-gray-100">
                    <div class="flex items-center gap-2 mb-4">
                        <span class="inline-flex items-center justify-center w-7 h-7 rounded-full bg-red-500 text-white text-sm font-bold">
                            {{ $i + 1 }}
                        </span>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text"
                                   name="pets[{{ $i }}][name]"
                                   class="input-field pet-name-input"
                                   required
                        ...
                        <div>
                            ...
                            <input type="text"
                                   name="pets[{{ $i }}][breed]"
                                   class="input-field pet-breed-input"
                                   required
                        ...
                        <div>
                            ...
                            <select name="pets[{{ $i }}][sex]"
                                    class="input-field pet-sex-select"
                                    required>
                                <option value="" disabled selected>Pilih jenis kelamin</option>
                                <option value="Jantan" {{ old("pets.$i.sex") == 'Jantan' ? 'selected' : '' }}>Jantan</option>
                                <option value="Betina" {{ old("pets.$i.sex") == 'Betina' ? 'selected' : '' }}>Betina</option>
                            </select>
        ...
        <div class="pt-8 border-t border-gray-200 mt-10">
            <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                <button type="button"
                        onclick="window.location.href='/screening/owner'"
                        class="submit-btn w-full sm:w-auto">
                    <i class="fas fa-arrow-left"></i> Back
                </button>

                <button type="submit" id="nextBtn" class="submit-btn w-full sm:w-auto">
