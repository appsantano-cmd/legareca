...
<body class="min-h-screen px-4 py-8">
    ...
    <div class="w-full max-w-4xl mx-auto">
        ...
        @if (isset($screening))
            ...
            <div class="section-card p-6 mb-6">
                ...
                <div class="space-y-6">
                    @foreach ($screening->pets as $index => $pet)
                        @php
                            // Cek apakah pet ini restricted dari $restrictedPets
                            $isRestricted = false;
                            $restrictionReasons = '';

                            foreach ($restrictedPets as $restrictedPet) {
                                if ($restrictedPet['pet_index'] == $index) {
                                    $isRestricted = true;
                                    if (is_array($restrictedPet['reasons'])) {
                                        $restrictionReasons = implode(', ', $restrictedPet['reasons']);
                                    } else {
                                        $restrictionReasons = $restrictedPet['reasons'];
                                    }
                                    break;
                                }
                            }

                            // Tentukan badge berdasarkan pet status
                            $petBadgeClass = 'success-badge';
                            $petBadgeText = 'Boleh Masuk';
                            $petBadgeIcon = 'fa-check-circle';

                            if ($isRestricted) {
                                $petBadgeClass = 'danger-badge';
                                $petBadgeText = 'Tidak Boleh Masuk';
                                $petBadgeIcon = 'fa-ban';
                            } elseif ($pet->status === 'Lanjut Obat') {
                                $petBadgeClass = 'warning-badge';
                                $petBadgeText = 'Lanjut Obat';
                                $petBadgeIcon = 'fa-prescription-bottle';
                            } elseif ($pet->status === 'Kutu Positif') {
                                $petBadgeClass = 'warning-badge';
                                $petBadgeText = 'Kutu Positif';
                                $petBadgeIcon = 'fa-exclamation-triangle';
                            } elseif ($pet->status === 'Birahi Positif') {
                                $petBadgeClass = 'warning-badge';
                                $petBadgeText = 'Birahi Positif';
                                $petBadgeIcon = 'fa-exclamation-triangle';
                            }
                        @endphp

                        <div class="pet-card p-5 {{ $isRestricted ? 'border-red-300 bg-red-50' : '' }}">
                            <!-- Pet Header -->
                            <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                                <div>
                                    <div class="flex items-center gap-2 mb-2">
                                        ...
                                        <span class="{{ $petBadgeClass }} text-sm">
                                            <i class="fas {{ $petBadgeIcon }} mr-1"></i>
                                            {{ $petBadgeText }}
                                        </span>
                                    </div>
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        ...
                                        @if ($pet->status !== 'Normal' && !$isRestricted)
                            ...
                            <!-- Alasan tidak boleh masuk -->
                            @if ($isRestricted && $restrictionReasons)
                                <div class="mb-4 p-3 bg-red-100 border border-red-300 rounded-lg">
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            <p class="font-medium text-red-800 text-sm">Tidak diperbolehkan masuk
                                                karena:</p>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="data-item">
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            @if ($pet->kutu_action)
                                                <span
                                                    class="info-badge {{ $pet->kutu_action == 'tidak_periksa' ? 'red' : 'yellow' }}">
                                    ...
                                    <div class="data-item">
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            @if ($pet->birahi_action)
                                                <span
                                                    class="info-badge {{ $pet->birahi_action == 'tidak_periksa' ? 'red' : 'yellow' }}">
                            ...
                            <div class="mt-4 pt-4 border-t border-gray-200">
                                <span class="text-sm text-gray-600">
                                    ...
                                    Status: <span class="font-medium">{{ $pet->status }}</span>
                                </span>
                            </div>
                        </div>
                    @endforeach
            ...
            <div class="section-card p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-4">
                        ...
                        @if (!empty($restrictedPets))
                            <div class="flex items-center justify-between">
                                <span class="text-gray-600">Tidak Boleh Masuk:</span>
                                <span class="font-bold text-red-600">{{ count($restrictedPets) }} anabul</span>
                            </div>
                        @endif
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-green-600 mt-1">
                                    Data anabul Anda telah tercatat di sistem. Terima kasih telah menggunakan layanan
                                    screening Le Gareca Space.
                                </p>
                                @if (!empty($restrictedPets))
                                    <p class="text-sm text-yellow-600 mt-2">
                                        <i class="fas fa-exclamation-triangle mr-1"></i>
                                        Perhatikan anabul yang tidak diperbolehkan masuk. Silakan hubungi staff untuk
            ...
            <div class="flex flex-col sm:flex-row gap-4 mt-8 justify-center items-center">
                <button type="button" onclick="window.print()" class="back-btn bg-blue-500 hover:bg-blue-600">
                    <i class="fas fa-print mr-2"></i>
                    Cetak Data
                </button>

                <button type="button" onclick="window.location.href='{{ route('screening.welcome') }}'"
                    class="back-btn">
                    <i class="fas fa-home mr-2"></i>
                    Kembali ke Home
                </button>

                <button type="button" onclick="window.location.href='{{ route('screening.thankyou') }}'"
                    class="back-btn bg-green-500 hover:bg-green-600">
        ...
        @else
            ...
            <div class="section-card p-8 text-center">
                ...
                <p class="text-gray-600 mb-6">Data screening tidak ditemukan. Silakan lakukan screening terlebih
                    dahulu.</p>
                <button type="button" onclick="window.location.href='{{ route('screening.welcome') }}'"
    ...
    <style media="print">
        @media print {
            ...
            /* Highlight restricted pets in print */
            .border-red-300 {
