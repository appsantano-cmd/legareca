    ...
    <div class="main-container">
        ...
        <div class="filter-card">
            <form action="{{ route('reservasi.inn.reservations.index') }}" method="GET" id="filterForm">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="search-box">
                            ...
                            <input type="text" class="form-control" name="search"
                                placeholder="Cari kode booking, nama, email, no. WA..." value="{{ request('search') }}">
                        </div>
                    </div>
                ...
                <input type="hidden" name="direction" id="sortDirection"
                    ...
                    <table class="table table-hover align-middle">
                        <thead class="table-light">
                            <tr>
                                <th width="5%">#</th>
                                <th width="12%">
                                    <a href="javascript:void(0)" onclick="sortTable('booking_code')"
                                    ...
                                    <td>
                                        <div class="d-flex flex-wrap gap-1">
                                            ...
                                            <a href="{{ route('reservasi.inn.reservations.edit', $reservation->id) }}"
                                                class="btn btn-sm action-btn btn-edit" title="Edit Reservasi">
                                            ...
                                            <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $reservation->phone) }}?text={{ urlencode('Halo ' . $reservation->full_name . ', Kami dari Legareca Inn ingin mengkonfirmasi reservasi Anda dengan kode booking: ' . $reservation->booking_code) }}"
                                                target="_blank" class="btn btn-sm action-btn btn-wa"
                                                title="Hubungi via WhatsApp">
                                                <i class="fab fa-whatsapp"></i>
                                            </a>

                                            <button type="button" class="btn btn-sm action-btn btn-danger"
                                            ...
                                            <div class="dropdown d-inline">
                                                <button class="btn btn-sm action-btn btn-secondary dropdown-toggle"
                                                    type="button" data-bs-toggle="dropdown" title="Ubah Status">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="javascript:void(0)"
                                                            ...
                                                            <i
                                                                class="fas fa-check-circle me-2 text-success"></i>Confirmed
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="javascript:void(0)"
                                                            ...
                                                            <i
                                                                class="fas fa-times-circle me-2 text-danger"></i>Cancelled
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="javascript:void(0)"
                                                            ...
                                                            <i
                                                                class="fas fa-flag-checkered me-2 text-secondary"></i>Completed
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
