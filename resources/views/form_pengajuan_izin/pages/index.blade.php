                    ...
                    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                        ...
                        <form method="GET" class="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
                            ...
                            <div class="relative flex-1">
                                ...
                                <input type="text" name="search" placeholder="Cari nama atau jenis izin..."
                        ...
                        <tbody class="divide-y divide-gray-200">
                            @forelse ($izin as $item)
                                ...
                                <tr class="hover:bg-gray-50 transition" data-id="{{ $item->id }}">
                                    ...
                                    <td class="p-4">
                                        <div class="text-sm">
                                            ...
                                            <div class="text-gray-500">
                                                s/d <span
                                                    class="tanggal-selesai">{{ \Carbon\Carbon::parse($item->tanggal_selesai)->translatedFormat('d M Y') }}</span>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="p-4">
                                        <span
                                            class="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-blue-100 text-blue-700 text-sm font-medium">
                                    ...
                                    <td class="p-4">
                                        <span
                                            class="inline-flex items-center gap-1 px-3 py-1.5 rounded-full text-xs font-semibold {{ $config['class'] }} status">
                                    ...
                                    <td class="p-4">
                                        <div class="flex items-center gap-2">
                                            ...
                                            @if($item->status == 'Pending')
                                                {{-- Tombol Setujui --}}
                                                <form action="{{ route('izin.update-status', $item->id) }}" method="POST" class="inline">
                                                    @csrf
                                ...
                                <tr>
                                    <td colspan="8" class="p-8 text-center">
                                        <div class="flex flex-col items-center justify-center py-8">
                                            ...
                                            <p class="text-gray-500 text-lg font-medium mb-2">Belum ada pengajuan izin
                                            </p>
                                            <p class="text-gray-400 text-sm mb-4">Mulai dengan membuat pengajuan izin
                                                baru</p>
                                            <a href="{{ route('izin.create') }}"
                        ...
                        @forelse ($izin as $item)
                            ...
                            <div class="mobile-card bg-white border border-gray-200 rounded-xl p-4 shadow-sm hover:shadow-md transition"
                                ...
                                <div class="flex justify-between items-start mb-3">
                                    ...
                                    <span
                                        class="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-semibold {{ $config['class'] }} status">
                                        <i class="{{ $config['icon'] }}"></i> {{ $item->status }}
                                    </span>
                                </div>
                                ...
                                <div class="space-y-2 text-sm mb-4">
                                    <div class="flex justify-between">
                                        ...
                                        <span
                                            class="font-medium text-gray-800 jenis-izin">{{ $item->jenis_izin }}</span>
                                    </div>
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span class="text-gray-800">
                                            <span
                                                class="tanggal-mulai">{{ \Carbon\Carbon::parse($item->tanggal_mulai)->translatedFormat('d M') }}</span>
                                            - <span
                                                class="tanggal-selesai">{{ \Carbon\Carbon::parse($item->tanggal_selesai)->translatedFormat('d M Y') }}</span>
                                        </span>
                                    </div>
    ...
    <div id="rejectModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl w-full max-w-md overflow-hidden">
            <form id="rejectForm" method="POST">
                ...
                <div class="p-6 border-b border-gray-200">
                    <h3 class="text-lg font-semibold text-gray-800 flex items-center gap-2">
                        <i class="fas fa-times-circle text-red-600"></i> Tolak Pengajuan Izin
                    </h3>
                </div>
