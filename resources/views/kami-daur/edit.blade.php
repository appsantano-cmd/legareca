...
<head>
    ...
    <title>Edit Produk & Material - Kami Daur #{{ $kamiDaur->id }}</title>
...
<body>
    <div class="container-fluid py-3">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-2 fw-bold">
                    <i class="fas fa-edit text-success me-2"></i>Edit Produk & Material
                </h1>
                <p class="text-muted mb-0">
                    <i class="fas fa-info-circle me-1"></i> 
                    Edit produk unggulan dan bahan/material daur ulang
                </p>
            </div>
            <div>
                <a href="{{ route('kami-daur.show', $kamiDaur) }}" class="btn btn-info text-white me-2">
        ...
        <!-- Form -->
        <form action="{{ route('kami-daur.update', $kamiDaur) }}" method="POST" id="configForm" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div id="products-container">
                        @php
                            $oldProducts = old('products', $kamiDaur->products ?? []);
                        @endphp
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div id="materials-container">
                        @php
                            $oldMaterials = old('materials', $kamiDaur->materials ?? []);
                        @endphp
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="border rounded p-2 bg-light text-center h-100 d-flex flex-column">
                                            ...
                                            <!-- Hidden input untuk menyimpan URL gambar lama jika tidak upload baru -->
                                            <input type="hidden" name="materials[{{ $index }}][image]" value="{{ $material['image'] ?? '' }}">
                                            
                                            <div class="file-info mt-2" id="material-file-info-{{ $index }}">
                                                <i class="fas fa-info-circle"></i> Format: JPG, PNG, WEBP (Max 2MB)
                                                @if(!empty($material['image']))
                                                <br><span class="text-success">Gambar saat ini: {{ Str::limit($material['image'], 30) }}</span>
                                                @endif
                                            </div>
                        ...
                        <div class="text-center py-4">
                            ...
                            <p class="text-muted">Belum ada material. Tambahkan material pertama Anda.</p>
                        </div>
                        @endforelse
                    </div>
            ...
            <div class="d-flex justify-content-between align-items-center mt-4 mb-5">
                ...
                <button type="submit" class="btn btn-success px-5 py-2">
                    <i class="fas fa-save me-2"></i> Update Konfigurasi
                </button>
            </div>
        </form>
    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            let productCount = {{ count($kamiDaur->products ?? []) }};
            let materialCount = {{ count($kamiDaur->materials ?? []) }};
            ...
            $('#configForm').on('submit', function(e) {
                ...
                $('.product-image-file, .material-image-file').each(function() {
                    if (this.files.length > 0) {
                        ...
                        if (fileSize > 2) {
                            errorMessage = 'Ukuran file gambar maksimal 2MB!';
                            isValid = false;
                            return false;
                        }
                    }
