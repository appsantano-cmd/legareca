                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-4 md:p-6 text-center">
                        ...
                        <div id="upload-area" class="cursor-pointer">
                            <div class="flex flex-col items-center">
                                ...
                                <p class="text-gray-700 font-medium mb-2 text-sm md:text-base">Upload photo of toilet</p>
                                <p class="text-gray-500 text-xs md:text-sm">JPG, PNG (No size limit)</p>
                                <div class="flex flex-col sm:flex-row gap-2 mt-4">
                                    <button type="button" onclick="openCamera()" class="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm hover:bg-blue-700 transition">
                                        <i class="fas fa-camera mr-1"></i> Take Photo
                                    </button>
                                    <button type="button" onclick="openGallery()" class="bg-gray-200 text-gray-800 px-4 py-2 rounded-lg text-sm hover:bg-gray-300 transition">
        ...
        document.getElementById('reportForm').addEventListener('submit', function(e) {
            ...
            if (input.files.length > 0) {
                ...
                if (file && file.size > 10 * 1024 * 1024) {
                    submitBtn.innerHTML = '<i class="fas fa-spinner fa-spin mr-2"></i>Uploading large file, please wait...';
                }
            }
        });
