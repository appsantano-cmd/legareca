            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4><i class="fas fa-utensils me-2"></i> Stok Kitchen</h4>
                        <div>
                    ...
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($stokKitchen as $item)
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">
                                                            <i class="fas fa-eye me-2"></i>Detail Stok Kitchen
                                                        </h5>
                                        ...
                                        <div class="modal fade" id="editModal{{ $item->id }}" tabindex="-1">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <form action="{{ route('stok-kitchen.update', $item->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="modal-header">
                                        ...
                                        <div class="modal fade" id="deleteModal{{ $item->id }}" tabindex="-1">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form action="{{ route('stok-kitchen.destroy', $item->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                            <p>Apakah Anda yakin ingin menghapus stok kitchen:</p>
                        ...
                        <div id="formSection" class="form-section" style="display: none;">
                            <h5 class="mb-4"><i class="fas fa-plus-circle me-2"></i> Form Tambah Stok Kitchen</h5>
