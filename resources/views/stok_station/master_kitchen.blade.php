        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4><i class="fas fa-utensils me-2"></i> Master Bahan Kitchen</h4>
                    <div>
                                            ...
                                            <form action="{{ route('master-kitchen.update', $item->id) }}" method="POST">
                                                ...
                                                <div class="modal-header">
                                                    <h5 class="modal-title">
                                                        <i class="fas fa-edit me-2"></i>Edit Master Bahan Kitchen
                                                    </h5>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{ route('master-kitchen.store') }}" method="POST">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">
                        <i class="fas fa-plus-circle me-2"></i>Tambah Master Bahan Kitchen
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
